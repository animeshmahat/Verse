...
<div class="d-flex flex-column">
    ...
    <div class="row">
        ...
        <div class="col-6 card shadow mb-auto mx-3 p-4">
            ...
            <hr>
            <form action="{{route('admin.profile.update', ['id' => $data['row']->id]) }}" method="post"
                ...
                <div class="form-group mt-3 mb-3">
                    ...
                    @else
                        <h4 class="alert alert-warning"><i class="fa-regular fa-file-image"></i> User Image Not Found!!!
                        </h4>
                    @endif
                </div>
                ...
                <hr>
                <div>
                    <a href="{{ route('admin.index') }}" class="btn btn-success btn-sm"><i class="fa fa-ban"></i>
                        CANCEL</a>
        ...
        <div class=" col-5 card shadow mb-auto mx-3 p-4">
            ...
            <hr>
            <form action="{{ route('admin.profile.passwordChange', ['id' => $data['row']->id]) }}" method="post"
                enctype="multipart/form-data">
                @csrf
                {{method_field('PUT')}}
